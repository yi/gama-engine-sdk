 ...
 *
 * 代码来自: http://jpauclair.net/2010/01/09/base64-optimized-as3-lib/
 */
package sgf.util
{
	...
	public class Base64
	{
		...
		public static function encode(data:ByteArray):String
		{
			...
			while (i < len)
			{
				...
				c = (_encodeChars[c >>> 18] << 24) | (_encodeChars[c >>> 12 & 0x3f] << 16) |
				(_encodeChars[c >>> 6 & 0x3f] << 8) | _encodeChars[c & 0x3f];
			...
			{
				c = data[i++] << 8 | data[i];
				c = (_encodeChars[c >>> 10] << 24) | (_encodeChars[c >>> 4 & 0x3f] << 16) |
				(_encodeChars[(c & 0x0f) << 2] << 8) | 61;
				out.writeInt(c);
			}
